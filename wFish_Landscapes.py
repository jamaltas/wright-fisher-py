...
def main():
    ...
    seq_length = 10             # This is "N"
    generations = 50000        # How long it runs
    mutation_rate = 1e-5     # per gen per individual per site
    repeats = 100              # Number of landscape replicates
    ...
    A = [1]*(2**seq_length)
    #noise = np.random.normal(0, .02, 2**seq_length)
